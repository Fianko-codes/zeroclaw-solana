...
| `ZEROCLAW_CONFIG_DIR=/home/anubhav/Documents/ZeroClaw/.m2-host-smoke ./target/release/zeroclaw plugin list --verbose` | 0 | Listed `solana-pay-request v0.1.0`. |
| `ZEROCLAW_CONFIG_DIR=/home/anubhav/Documents/ZeroClaw/.m2-host-smoke ./target/release/zeroclaw plugin info solana-pay-request --verbose` | 0 | Reported capability `Tool`, permission `ConfigRead`, and the installed component path. |
